    ...
    <div className="min-h-screen bg-gradient-earth">
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
          {/* Patient Profiles */}
          <Card
            className="shadow-healing hover:shadow-warm transition-all duration-300 cursor-pointer group"
          ...
          >
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Manage patient information, conduct assessments, and view health
                summaries
              </CardDescription>
            </CardHeader>
          ...
          >
            <CardHeader className="text-center">
              ...
              <CardDescription>
                AI-powered automatic diet chart generation based on patient
                analysis
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                ...
                analysis for patient monitoring
              </CardDescription>
            </CardHeader>
            <CardContent>
              <AdvancedFoodScanner />
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <Card className="shadow-soft">
            <CardHeader>
              ...
              <CardDescription>
                Latest patient interactions and diet chart generations
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
