    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialization', models.CharField(choices=[('general', 'General Ayurveda'), ('nutrition', 'Ayurvedic Nutrition'), ('panchakarma', 'Panchakarma'), ('lifestyle', 'Lifestyle Medicine'), ('chronic-diseases', 'Chronic Diseases'), ('pediatric', 'Pediatric Ayurveda'), ('geriatric', 'Geriatric Ayurveda'), ('women-health', "Women's Health"), ('mental-health', 'Mental Health')], max_length=50)),
